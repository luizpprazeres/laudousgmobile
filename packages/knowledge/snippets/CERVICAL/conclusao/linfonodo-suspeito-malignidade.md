---
id: cervical-conclusao-linfonodo-suspeito-malignidade
category: CERVICAL
kind: conclusao
tags: [cervical, conclusao, suspeito, malignidade, metastase, linfoma]
priority: 85
...
GATILHOS DE APLICAÇÃO: "linfonodo suspeito", "linfonodo atípico", "perda do hilo", "linfonodo arredondado", "necrose central", "microcalcificações", "vascularização periférica", "vascularização aberrante", "linfonodo > 15 mm", "metástase linfonodal", "linfonodo suspeito malignidade".

CONCLUSÃO — LINFONODO COM CARACTERÍSTICAS SUSPEITAS DE MALIGNIDADE

═══════════════════════════════════════════════════
REQUISITO PRÉ-APLICAÇÃO
═══════════════════════════════════════════════════

USAR ESTA CONCLUSÃO quando o médico DOCUMENTOU achados ecográficos que JUSTIFICAM, em seu juízo clínico, suspeição de atipia (ver regra/criterios-linfonodo-normal-vs-suspeito.md para os sinais ecográficos sugestivos).
...
Critérios a citar conforme presentes nos achados do médico:
- "Perda do hilo ecogênico"
- "Forma arredondada (razão eixo curto/longo = ___)"
- "Cortical hipoecoica difusa, espessada (___ mm)"
- "Microcalcificações intra-linfonodais"
- "Necrose central (área anecoica ___ x ___ mm)"
- "Vascularização periférica/aberrante ao Doppler"
- "Eixo curto aumentado (___ mm) — limítrofe para o nível [Robbins]"
...
Sempre incluir no escopo da conclusão (frase obrigatória):
"O diagnóstico definitivo requer correlação clínica e, quando indicado, confirmação histopatológica."
