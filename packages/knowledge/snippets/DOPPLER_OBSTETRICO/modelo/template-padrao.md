---
id: doppler-obstetrico-modelo-template-padrao
category: DOPPLER_OBSTETRICO
kind: modelo
tags: [doppler-obstetrico, template, obstetrica, dopplervelocimetria, gestacao]
priority: 100
...
TEMPLATE: O template abaixo deve ser reproduzido exatamente, sem qualquer alteração estrutural ou textual, exceto nos campos variáveis.

2. ULTRASSONOGRAFIA OBSTÉTRICA COM DOPPLER COLORIDO
