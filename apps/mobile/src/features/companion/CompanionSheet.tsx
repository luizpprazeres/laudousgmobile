              ...
              <>
                ...
                {imageFindings ? (
                  <View style={styles.findingsCard}>
                    <Text style={styles.findingsTitle}>{categoryId === 'TIREOIDE' ? 'Tireoide e nódulos encontrados' : categoryId === 'MAMARIA' ? 'Achados mamários encontrados' : 'Medidas encontradas'} — revise antes de enviar</Text>
