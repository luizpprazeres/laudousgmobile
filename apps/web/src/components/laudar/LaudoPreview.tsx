...
export function LaudoPreview({ text, initialsOn, onToggleInitials, initials, saveState = 'idle', saveError, onSave }: Props) {
  ...
  return (
    <section className="flex min-h-0 flex-col border-l border-gray-200 bg-gray-100 dark:border-gray-800 dark:bg-gray-900">
      <div className="sticky top-0 z-10 border-b border-gray-200 bg-white/80 px-5 py-4 backdrop-blur-xl dark:border-gray-800 dark:bg-gray-950/80">
        <div className="mb-3 flex items-center justify-between gap-3">
          <div>
            <div className="font-mono text-[10px] font-bold uppercase tracking-[0.18em] text-gray-500 dark:text-gray-400">Preview · laudo</div>
