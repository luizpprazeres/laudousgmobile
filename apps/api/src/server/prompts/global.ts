...
/**
 * Reforço de intenção e completude — atrás da flag WRITER_HARDENING (default
 * OFF). Endereça a família de defeitos do boletim de 100 laudos: átomo do
 * ditado que some, negação que vira frase normal, comando executado como texto,
 * achado inesperado sem lugar.
 *
 * Entra como bloco ADICIONAL no fim do system message; não substitui nada.
 */
