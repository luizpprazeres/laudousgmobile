...
export async function POST(req: Request) {
  ...
  // Normaliza transformações determinísticas (medidas 'A por B'→'A x B', datas
  // faladas → dd/mm/aaaa) no transcript ANTES de persistir e de qualquer LLM.
  // Garble irrecuperável vira [REVISAR], nunca adivinha. Cobre Deepgram direto
  ...
  return sseResponse(async ({ emit }, signal) => {
    ...
    try {
      ...
      if (decisao.outcome === "aborted") {
        ...
        // legítimo do médico, e contando como laudo criado nas métricas.
        // Produção tinha 29 linhas assim em 10/08 (17/05 a 22/07), contra 3.346
        // geradas: gotejamento, não vazamento.
        //
        ...
        // outcome de erro — a auditoria do porquê não se perde.
        //
